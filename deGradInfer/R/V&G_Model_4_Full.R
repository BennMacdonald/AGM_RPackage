...
### Parameters: There are 7 kinetic parameters
...
gradientsVGModel4Full <- function(params,X,timepoints=NULL,auxVars,species
					  )
{
...
odeVGModel4Full <- function(t,X,params)
{
...
### Creation of simulation VG model 4. It uses the function "ode" in the cran
...
simulateVGModel4Full <- function(xInit,t,params,...)
{
	solution <- ode(xInit,t,odeVGModel4Full,params,...)
